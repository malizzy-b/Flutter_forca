...
class _GameScreenState extends State<GameScreen> {
  ...
  int lives = 5;
  Alfabeto englishAlphabet = Alfabeto();
  late String word;
  ...
  Widget createButton(index) {
    return Container(
      ...
      child: Center(
        child: WordButton(
          buttonTitle: englishAlphabet.alfabeto[index].toUpperCase(),
  ...
  void wordPress(int index) {
    ...
    setState(() {
      for (int i = 0; i < wordList.length; i++) {
        if (wordList[i] == englishAlphabet.alfabeto[index]) {
          check = true;
          wordList[i] = '';
      ...
      if (!check) {
        hangState += 1;
        remainingAttempts -= 1; // Decrementa as tentativas restantes
        wrongAttempts += 1; // Incrementa as tentativas erradas
      }
            ...
            children: <Widget>[
              DrawerHeader(
                decoration: BoxDecoration(
                  color: Color(0xFF4B078A),
                ),
                child: Text(
                  'Marina Nogueira - 1431432312009',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20.0,
                  ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                            child: Text(
                              "Erradas: $wrongAttempts / Restantes: $remainingAttempts",
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                            ...
                            child: IconButton(
                              ...
                              onPressed: hintStatus
                                  ? () {
                                      ...
                                      wordPress(englishAlphabet.alfabeto
                                          .indexOf(
